...
public class AdminAttendanceController {
    ...
    @PostMapping
    public ApiResponse<AttendanceDto.AttendanceResponse> register(
    ...
    public ApiResponse<AttendanceDto.SessionAttendanceSummaryResponse> sessionSummary(@PathVariable Long sessionId) {
        return ApiResponse.success(attendanceService.getSessionSummary(sessionId));
    }

    @GetMapping("/members/{memberId}")
    public ApiResponse<List<AttendanceDto.AttendanceResponse>> memberAttendances(@PathVariable Long memberId) {
        return ApiResponse.success(attendanceService.getMemberAttendances(memberId));
    }

    @GetMapping("/sessions/{sessionId}")
    public ApiResponse<List<AttendanceDto.AttendanceResponse>> sessionAttendances(@PathVariable Long sessionId) {
