...
public class AdminMemberController {
    ...
    @PostMapping
    public ApiResponse<MemberDto.MemberDetailResponse> create(@Valid @RequestBody MemberDto.CreateMemberRequest request) {
    ...
    public ApiResponse<PageResponse<MemberDto.MemberDetailResponse>> dashboard(
        ...
        return ApiResponse.success(memberService.getAdminMembers(page, size));
    }
